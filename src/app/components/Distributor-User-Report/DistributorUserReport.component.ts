...
@Component({
  selector: 'app-distributor-user-report',
  standalone: true,
  ...
  templateUrl: './DistributorUserReport.component.html',
  styleUrls: ['./DistributorUserReport.component.scss']
})

export class DistributorUserReportComponent implements OnInit {

  /** Scope: only users created under the currently logged-in Distributor (AdId). */
  readonly scopeType = 'AD';
