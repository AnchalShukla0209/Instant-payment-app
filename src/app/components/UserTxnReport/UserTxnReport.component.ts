...
export class UserTxnReport implements OnInit {
  ...
  services = ['All Service', 'RECHARGE', 'AEPS', 'MATM', 'DTH', 'BILL PAYMENT', 'DMT', 'UPI', 'QR CODE', 'ONLINE PAYMENT', 'LESSER REPORT'];
  ...
  columnConfig: any = {
    'All Service': ['Sr No', 'TXN ID', 'Bank Name', 'BankRefNo', 'Operator Name', 'Account No', 'Opening Bal', 'Amount', 'Closing', 'Status', 'TimeStamp', 'Updated Time', 'E-Invoice'],
    ...
    'AEPS': ['Sr No', 'TXN ID', 'Bank Name', 'BankRefNo', 'Operator Name', 'Account No', 'Opening Bal', 'Amount', 'Closing', 'Status', 'TimeStamp', 'Updated Time', 'E-Invoice'],
    ...
    'ONLINE PAYMENT': ['Sr No', 'TXN ID', 'Opening Bal', 'Amount', 'Closing', 'Status', 'TimeStamp', 'Updated Time', 'E-Invoice'],
    'LESSER REPORT': ['Sr No', 'Opening Bal', 'Amount', 'Closing', 'Status', 'TimeStamp', 'Updated Time'],
  ...
  openInvoiceModal(row: any) {
    ...
    } else if (row.OperatorName === 'DMTTXN') {
