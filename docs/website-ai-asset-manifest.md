...
Future generations must use `ambassador-master.png` as the identity reference and explicitly preserve the face, glasses, hair, age, complexion and wardrobe language.

## Production assets

### 1. `fintech-network-hero.png`
...
### 3. `ambassador-retail-partner.png`
...
### 4. `ambassador-india-network.png`
...
### 6. `connected-services-ecosystem.png`
...
|---|---|
| Hero | `fintech-network-hero.png` |
| About / retailer story | `ambassador-retail-partner.png` |
| Product ecosystem | `connected-services-ecosystem.png` |
| Security | `security-infrastructure.png` |
| Why Choose Us | `ambassador-india-network.png` |
| Ambassador profile | `ambassador-master.png` |
